        ...
        protected override async Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            if (bool.TryParse(generateParametersFileString, out var generateParametersFile) && generateParametersFile)
            {
                ...
                try
                {
                    ...
                    // Log a message.
                    _logger.LogInformation($"The default parameters have been written in JSON format to the file \"{outputFile}\".");
                }
                catch (Exception exception)
                {
                    // Log an error.
                    _logger.LogError($"The error \"{exception.Message}\" occured while writing the default parameters to the file \"{outputFile}\". The default parameters will be displayed below instead.");
                    // Log the output text.
